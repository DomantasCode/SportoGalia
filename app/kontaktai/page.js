...
export const metadata = {
  title: 'Kontaktai - Sportogalia',
  description: 'Susisiekite su Sportogalia komanda',
}
    ...
    <div className="bg-white">
      ...
      <div className="relative bg-dark-900 overflow-hidden">
        <div className="absolute inset-0">
          <Image
            src="/images/news-images/naujienos-19-card.jpg"
            alt="Kontaktai"
            fill
        ...
        <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-24 sm:py-32">
          <div className="max-w-3xl">
            ...
            <p className="mt-4 text-xl text-gray-200">
              Susisiekite su mumis - mielai atsakysime į visus jūsų klausimus
            </p>
          </div>
        </div>
      </div>
